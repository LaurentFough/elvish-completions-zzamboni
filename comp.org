...
#+begin_src elvish
use github.com/LaurentFough/elvish-completions-zzamboni/comp
#+end_src
...
*Example #4:* See the [[https://github.com/LaurentFough/elvish-completions-zzamboni/blob/master/ssh.org][ssh completer]] for a real-world example of using sequences.
...
*Example #7:* See the [[https://github.com/LaurentFough/elvish-completions-zzamboni/blob/master/git.org][git completer]] for a real-world subcommand completion example, which also shows how extensively auto-population of subcommands and options can be done by extracting information from help messages.
